...
//        You want to find the sum of the differences between the indices of pairs of numbers
//        that are in the wrong order. A pair of numbers is considered to be in the wrong order
...
//        inversion will be (index of array[4]-index of array[0]) = 4-0=4 and
...
//        inversion will be 4+(index of array[4]-index of array[2])=4+(4-2)=4+2=6.
